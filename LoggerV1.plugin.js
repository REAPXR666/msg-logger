...
module.exports = class MessageLoggerV2 {
    ...
    getDescription() {
        return 'Log Every Message On Discord Whether Edited Or Deleted - Created By REAPXR#5664';
    }
    load() {}
    start() {
        let onLoaded = () => {
            try {
                ...
                this.stop();
                XenoLib.Notifications.error(`[**${this.getName()}**] Failed to start! Try to CTRL + R To Reset Plugin`, {
                    timeout: 0
                });
            }
        };
        ...
        if (!global.XenoLib || !global.ZeresPluginLibrary || XenoLibOutdated || ZeresPluginLibraryOutdated) {
            ...
            class k extends BdApi.React.PureComponent {
                constructor(a) {
                    super(a), this.state = {
                        hasError: !1
                    }, this.componentDidCatch = a => (console.error(`Error in ${this.props.label}, screenshot or copy paste the error above to REAPXR for help.`), this.setState({
                        hasError: !0
...
*/
        ...
        const MLV2ImageModal = props =>
            ZeresPluginLibrary.DiscordModules.React.createElement(
                ...
                // { className: ImageModalClasses.modal, ...props, size: Modals.ModalSize.DYNAMIC },
                {
                    ...
                    ...props,
                    size: ZLibrary.WebpackModules.getByProps("Header", "Footer").Sizes.DYNAMIC
                },
                ZeresPluginLibrary.DiscordModules.React.createElement(
                    ImageModal,
                    Object.assign({
    ...
    automaticallyUpdate(tryProxy) {
        ...
        new Promise(resolve => {
            ...
            const req = https.get(tryProxy ? 'https://cors-anywhere.herokuapp.com/https://raw.githubusercontent.com/1Lighty/BetterDiscordPlugins/master/Plugins/MessageLoggerV2/MessageLoggerV2.plugin.js' : 'https://raw.githubusercontent.com/1Lighty/BetterDiscordPlugins/master/Plugins/MessageLoggerV2/MessageLoggerV2.plugin.js', {
                headers: {
                    'origin': 'discord.com'
                }
            }, res => {
    ...
    cacheChannelMessages(id, relative) {
        ...
        ZeresPluginLibrary.DiscordModules.MessageActions.fetchMessages({
            channelId: id,
            limit: 50,
            jump: (relative && {
                messageId: relative,
    ...
    createModal(options, image, name) {
        ...
        */
        ...
        const modalKey = ModalActions.openModal(props => {
            ...
            }, React.createElement(ConfirmationModal, Object.assign({}, options, props, options.onClose ? {
                onClose: options.onClose
            } : {}), React.createElement(ErrorBoundary, {}, ZeresPluginLibrary.DiscordModules.React.createElement(modal, {
                ...
                const createEditedMessage = (edit, editNum, isSingular, noSuffix) => {
                  try{
                    ...
                    return BdApi.React.createElement(
                      ...
                      {
                        position: "left",
                        text: "Edited: "+this.tools.createMomentObject(edit.time).format('LLLL'),
                      },
                      (props) =>
